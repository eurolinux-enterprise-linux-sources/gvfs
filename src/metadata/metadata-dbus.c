...
static const _ExtendedGDBusArgInfo * const _gvfs_metadata_method_info_get_tree_from_device_IN_ARG_pointers[] =
{
  &_gvfs_metadata_method_info_get_tree_from_device_IN_ARG_major,
  &_gvfs_metadata_method_info_get_tree_from_device_IN_ARG_minor,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _gvfs_metadata_method_info_get_tree_from_device_OUT_ARG_pointers[] =
{
  &_gvfs_metadata_method_info_get_tree_from_device_OUT_ARG_tree,
  NULL
};
...
static const _ExtendedGDBusMethodInfo * const _gvfs_metadata_method_info_pointers[] =
{
  ...
  &_gvfs_metadata_method_info_get_tree_from_device,
  NULL
};
 ...
 * @proxy: A #GVfsMetadataProxy.
 * @out_tree: (out): Return location for return parameter or %NULL to ignore.
